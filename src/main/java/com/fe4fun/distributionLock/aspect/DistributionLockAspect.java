package com.fe4fun.distributionLock.aspect;

import com.fe4fun.distributionLock.annotation.DistributionLockAnnotation;
import com.fe4fun.distributionLock.exception.CannotAcquireLockException;
...
public class DistributionLockAspect {
    ...
    @Pointcut(value = "@annotation(com.fe4fun.distributionLock.annotation.DistributionLockAnnotation)")
